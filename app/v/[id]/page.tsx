...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokeptocil.pages.dev/v/${file.file_code}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokeptocil.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokeptocil.pages.dev/v/${file.file_code}`
            }  
        }
        }
